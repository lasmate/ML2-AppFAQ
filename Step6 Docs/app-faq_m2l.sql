...
--
-- Hôte : localhost
-- Généré le : ven. 11 avr. 2025 à 08:50
...
CREATE TABLE `faq` (
  ...
  `mots_cles` varchar(25) DEFAULT NULL,
...
INSERT INTO `faq` (`id_Q`, `id_FAQ`, `question`, `reponse`, `mots_cles`, `dat_question`, `dat_reponse`, `id_user`, `id_user_R`, `Valider`) VALUES
(1, 1, 'Quand est-ce qu\'il est le prochain tournoi ? ', 'Le prochain tournoi est dans 3 semaines.', NULL, '2025-02-04 14:04:41', '2025-02-04 14:04:41', 3, 1, 1),
(3, 3, 'Qu\'elle est l\'enjeux du prochain tournoi ?', 'L\'enjeux du prochain tournoi se sera les championnats de France.', NULL, '2025-02-04 14:09:41', '2025-02-04 14:09:41', 1, 11, 1),
(4, 5, 'j\'aimerai savoir quand se passera le tournoi de basket', 'pas avant septembre', NULL, '2025-03-05 16:10:43', '2025-03-05 16:10:43', 1, 16, 1),
(5, 2, 'combien de panier on ete marque pas le numero 6 cette saison? ', '0 il etait sur le banc tout la saison ', NULL, '2025-03-11 15:37:34', '2025-03-11 15:37:34', 3, 25, 1),
(6, 2, 'Ou se trouve le tournoi ?', NULL, NULL, '2025-03-27 14:18:40', '2025-03-27 14:18:40', 30, NULL, 1),
(7, 1, 'blabla', 'blibli', NULL, '2025-03-28 15:09:12', '2025-03-28 15:09:12', 11, 12, 1);
...
(1, 'lya_lasvenes', 'LyaLya', 'abc@gmail.com', 1, 5),
...
--
ALTER TABLE `faq`
  MODIFY `id_Q` bigint(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `user`
  MODIFY `id_user` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
COMMIT;
